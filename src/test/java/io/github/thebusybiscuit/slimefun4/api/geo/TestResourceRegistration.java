...
class TestResourceRegistration {
    ...
    void testNetherIceResource() {
        ...
        GEOResource resource = testResource(key, "下界冰", SlimefunItems.NETHER_ICE, true, 6);
    ...
    void testUraniumResource() {
        ...
        GEOResource resource = testResource(key, "一小堆铀", SlimefunItems.SMALL_URANIUM, true, 2);
    ...
    void testSaltResource() {
        ...
        GEOResource resource = testResource(key, "盐", SlimefunItems.SALT, true, 18);
