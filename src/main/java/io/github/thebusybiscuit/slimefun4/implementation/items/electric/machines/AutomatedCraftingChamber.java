...
public abstract class AutomatedCraftingChamber extends SlimefunItem implements InventoryBlock, EnergyNetComponent {
        ...
        new BlockMenuPreset(getId(), "&6自动合成机") {
            ...
            public void newInstance(BlockMenu menu, Block b) {
                if (!BlockStorage.hasBlockInfo(b) || BlockStorage.getLocationInfo(b.getLocation(), "enabled") == null || BlockStorage.getLocationInfo(b.getLocation(), "enabled").equals(String.valueOf(false))) {
                    menu.replaceExistingItem(6, new CustomItem(Material.GUNPOWDER, "&7已启用: &4\u2718", "", "&e> 点击启用机器"));
                    ...
                    menu.replaceExistingItem(6, new CustomItem(Material.REDSTONE, "&7已启用: &2\u2714", "", "&e> 点击关闭机器"));
                    menu.addMenuClickHandler(6, (p, slot, item, action) -> {
                ...
                menu.replaceExistingItem(7, new CustomItem(Material.CRAFTING_TABLE, "&7上一次的合成", "", "&e> 点击使用上一次的合成配方合成物品", "&c仅在有上一次合成时有效"));
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        ...
        preset.addItem(2, new CustomItem(new ItemStack(Material.CRAFTING_TABLE), "&e配方", "", "&b按要合成的物品的合成表放入", "&4仅对高级工作台能合成的物品有效"), (p, slot, item, action) -> false);
    }
